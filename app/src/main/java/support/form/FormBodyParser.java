...
/**
 * Form body parsing utilities.
 * 
 * Contains code from jersey (see above copy right).
 *
 * @author nikku
 */
public class FormBodyParser {
  ...
  /**
   * Parse the request body into a {@link MultivaluedMap<String,String>}.
   * 
   * Ths is a copy of {@link org.glassfish.jersey.message.internal.AbstractFormProvider#readFrom(javax.ws.rs.core.MultivaluedMap, javax.ws.rs.core.MediaType, boolean, java.io.InputStream) }.
   * 
   * @param <M>
   * @param map
   * @param mediaType
   ...
   * @throws IOException 
   */
  public static <M extends MultivaluedMap<String, String>> M readFrom(M map,
